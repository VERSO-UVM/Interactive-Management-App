...
'''
The IdeaVoting class encapsulates information about an idea, allowing retrieval and modification of its title,
category, number of votes, and percentage of votes.
